    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md text-center">
        <Card className="text-left p-4">
            <h2 className="text-xl font-bold mb-2 sticky top-0 bg-gray-800 py-1 border-b border-gray-700 -mx-4 px-4 text-center text-white">{t('results.title')}</h2>
            <ul className="mt-4">
        ...
        <Card className="bg-gray-900 mt-6 mb-8 p-4">
            <h2 className="font-semibold text-lg text-white mb-1">{t('results.rewards')}</h2>
            <p className="text-yellow-400 text-xl font-bold whitespace-nowrap">+ {formatCurrency(result.eurosEarned)}</p>
        </Card>
